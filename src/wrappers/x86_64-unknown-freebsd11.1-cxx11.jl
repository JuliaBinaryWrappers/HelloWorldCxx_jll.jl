# Autogenerated wrapper script for HelloWorldCxx_jll for x86_64-unknown-freebsd11.1-cxx11
export hello_world
...
function __init__()
    ...
    global hello_world_path = abspath(joinpath(artifact"HelloWorldCxx", hello_world_splitpath...))
